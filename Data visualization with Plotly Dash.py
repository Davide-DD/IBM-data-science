...
def get_pie_chart(entered_site, payload_range):
    if entered_site == 'ALL':
        ...
        (spacex_df['Payload Mass (kg)'] <= payload_range[1]) & (spacex_df['Launch Site'] == entered_site)],
        x='Payload Mass (kg)', y='class', color='Booster Version Category',
...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site-dropdown', value='ALL', placeholder='Select a Launch Site here', searchable='True', options=options),
                                html.Br(),
